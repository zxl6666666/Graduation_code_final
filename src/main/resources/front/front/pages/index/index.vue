...
<view class="list-box style1"
    ...
    <view @tap="onDetailTap('shipin',product.id)" v-for="(product,index) in shipinList"
        ...
        <view
                ...
                class="list-item-title hide1">{{product.shipinName}}
        </view>
        <image
                ...
                :src="baseUrl+product.shipinPhoto"></image>
    </view>
</view>        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            this.shipinList.forEach(function(item, index) {
